    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mt-2">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <textarea class="form-control"  wire:model.defer='alamat' name="" id="" cols="10" rows="5"></textarea>
                            </div>
                          </div>
                    </div>
                </div>  
        ...
        <div class="modal-footer">
          ...
          <button type="button" wire:click="resettext" class="btn btn-primary">reset</button>
        </div>
      </div>
    </div>
  </div>
